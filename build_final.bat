@echo off
echo 🚀 Building ChromiumFresh + NaviGrab (Final Version)
echo ==================================================
...
echo.
echo 🔧 Using fixed CMakeLists.txt...
copy "CMakeLists_fixed.txt" "CMakeLists.txt"
echo ✅ Updated CMakeLists.txt

echo.
echo 🔧 Using simplified NaviGrab CMakeLists.txt...
copy "NaviGrab\CMakeLists_simple.txt" "NaviGrab\CMakeLists.txt"
...
if %ERRORLEVEL% neq 0 (
    ...
    if not exist "cmake\chromium_playwright_config.cmake.in" (
        echo ❌ Missing cmake\chromium_playwright_config.cmake.in
    )
    echo.
